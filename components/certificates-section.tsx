            ...
            {certificatesData.certificates.map((cert, index) => (
              <SwiperSlide key={index}>
                <Card className="min-w-[310px] my-1 group transition-all duration-500 relative overflow-hidden border-2 border-border/80 hover:border-primary/60 bg-muted/40 shadow-lg hover:shadow-xl">
                  ...
                  {/* ✅ Number Badge (same as project section) */}
                  <div className="absolute top-5 right-3 bg-primary text-white text-[11px] font-semibold rounded-full w-[32px] h-[32px] flex items-center justify-center shadow-md">
                    {index + 1}/{certificatesData.certificates.length}
                  </div>
                  ...
                  <CardHeader className="pb-2">
                    <div className="flex items-start justify-between">
                      ...
                      {/* Removed ACTIVE badge and replaced with numbering only */}
                    </div>
                  ...
                  <CardContent>
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full h-[36px] md:h-[38px] text-[12px] gap-2 border-2 border-border/80 hover:border-primary/60 hover:bg-primary hover:text-primary-foreground"
