    ...
    >
      <div className="container lg:px-36 md:px-16 px-2 mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-between gap-8 lg:gap-[60px]">
          {/* Hero Content - Left side (70% on large screens) */}
          <div className="w-full lg:w-[60%] text-center lg:text-left order-2 lg:order-1 px-1 xs:px-2 sm:px-0">
            <h1
              ...
              {heroData.buttons.map((button, index) => (
                <Button
                  ...
                  className={`group w-full sm:w-auto ${
                    button.type === "outline"
                      ? "bg-transparent border-2 border-border/80 hover:border-primary/60 dark:border-border/80 dark:hover:border-primary/70"
                      : ""
                  } text-sm xs:text-base transition-all duration-300 ease-out hover:shadow-lg`}
                >
          ...
          {/* Profile Image - Right side (30% on large screens) */}
          <div className="flex justify-center lg:justify-end order-1 lg:order-2 mb-6 lg:mb-0 w-full lg:w-[30%]">
            <div className="relative">
              <div
                className={`w-40 h-40 xs:w-56 xs:h-56 sm:w-64 sm:h-64 md:w-90 md:h-90 rounded-full duration-900 overflow-hidden border-4 border-primary/20 shadow-xl transform transition-all duration-700 ease-out ${
                  isVisible
